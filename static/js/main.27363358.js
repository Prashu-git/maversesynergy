    ...
    n.n = function (e) {
        ...
        function () {
            ...
            var nt = [{
                ...
                at = [{
                    id: "1",
                    comment: "Whether you want to work in graphic or CADD design, this training centre is an excellent choice. You will receive outstanding training and unparalleled customized attention, ensuring that you develop the skills and knowledge necessary to thrive in these sectors.",
                    name: "Shivaraj",
                    company: ""
                }, {
                    id: "2",
                ...
                return (0, Ye.jsxs)("div", {
                    ...
                    children: [(0, Ye.jsxs)("div", {
                        ...
                        children: [(0, Ye.jsx)("h2", {
                            ...
                            children: "Email: info@maverse.com"
            ...
            var Pi = {
                ...
                Ai = [{
                    id: "1",
                    title: "Abacus",
                    description: " The abacus, an ancient calculating tool with roots spanning diverse civilizations, remains an enduring symbol of early computation. Its simple yet ingenious design a frame with movable beads representing different place values enabled users to perform complex arithmetic without written numerals. From its origins in Mesopotamia, Egypt, and China to its various cultural iterations like the soroban and suanpan, the abacus served as a fundamental tool for merchants, scholars, and learners, fostering mental arithmetic and visual memory skills. Its legacy persists today, not only in traditional usage but also in digital adaptations and its influence on computational algorithms, showcasing its lasting impact on mathematical education and the evolution of computing methods.The abacus, a timeless invention integral to the historical tapestry of mathematics, transcends eras and civilizations with its fundamental role in arithmetic. Evolving across cultures and epochs, from early counting boards to the refined Chinese soroban and Japanese suanpan, this ingenious tool embodies the essence of computation. Its design, comprising beads on rods denoting place values, facilitated swift mental calculations, empowering users in trade, scholarship, and everyday life. Beyond its practical utility, the abacus symbolizes mathematical prowess and cultural heritage, persisting as a touchstone for education and a testament to humanity's quest for efficient problem-solving tools, even amidst the digital age. Originating in ancient civilizations and evolving across cultures, its design—simple yet powerful—revolutionized arithmetic calculations. This ingenious frame, adorned with movable beads representing numerical values, transformed complex math into a visual and tactile experience, fostering mental agility and calculation prowess. Despite the advent of modern computing, the abacus remains a symbol of mathematical dexterity, revered for its historical significance, cultural resonance, and continued relevance in educational settings where it cultivates not just computational skills but a deep appreciation for the art and elegance of mathematics." ,       
                ...
                },
                 {
                    id: "2",
                    title: "CADD Design",
                    description: "Embarking on a journey in Computer-Aided Design and Drafting (CADD) opens doorways to a realm where innovation meets precision, shaping the future of design across industries. Our comprehensive CADD training programs delve into the core principles and advanced techniques, equipping individuals with the expertise needed to navigate complex design landscapes. From mastering software like AutoCAD, SolidWorks, and Revit to honing 3D modeling, architectural drafting, and mechanical design skills, our courses cater to diverse interests and professional aspirations. Our seasoned instructors, with hands-on industry experience, guide learners through a dynamic curriculum, blending theoretical foundations with practical applications. Our commitment goes beyond mere instruction; we foster an environment conducive to creativity, problem-solving, and critical thinking, nurturing the next generation of designers and architects. Join us on this transformative journey where innovation converges with imagination, empowering individuals to turn design concepts into tangible, impactful realities that shape our world. In the realm of design, where creativity meets technology, mastering Computer-Aided Design and Drafting (CADD) is a gateway to unleashing boundless potential. Our specialized CADD training programs offer a holistic approach to understanding the intricacies of design, providing a robust foundation for aspiring designers, architects, engineers, and creative minds alike. With a focus on industry-relevant software such as AutoCAD, SketchUp, CATIA, and more, our courses are tailored to meet the evolving demands of the design landscape. Through hands-on exercises, project-based learning, and mentorship from seasoned professionals, students gain proficiency in 2D and 3D modeling, architectural rendering, product design, and structural analysis. Beyond software proficiency, our curriculum emphasizes design thinking, problem-solving methodologies, and collaboration, preparing individuals to tackle real-world challenges with confidence and innovation. Whether embarking on a career in architecture, product development, or manufacturing, our CADD training equips learners with the skills and mindset needed to excel in a dynamic and competitive design industry. Join us and unlock your potential to create, innovate, and shape the future through the power of design.",
                    syllabusTitle: "",
                    syllabus: []
                }, {
                    id: "3",
                    title: "Graphic Design",
                    description: " Graphic design is the intersection where artistry meets functionality, breathing life into visual communication across diverse mediums. At our institute, we offer a comprehensive curriculum tailored to nurture the creative instincts and technical skills of aspiring graphic designers. Our courses delve into the principles of design, typography, color theory, and layout, empowering students to craft compelling visual narratives. From mastering industry-standard software like Adobe Photoshop, Illustrator, and In Design to exploring branding, user experience design, and digital illustration, our programs encompass a spectrum of tools and techniques crucial for success in today's design landscape. Our experienced faculty, comprised of industry professionals, guide students through hands-on projects, encouraging experimentation and honing their creative voice. Emphasizing traditional design principles and contemporary trends, our curriculum prepares graduates to thrive in a competitive market, equipping them with a portfolio that showcases their unique style and proficiency. Join us in a transformative journey where imagination merges with technical expertise, shaping the future of visual communication and design innovation. Graphic design is more than just creating visuals. Our graphic design courses go beyond software proficiency, nurturing a deeper understanding of design principles and visual storytelling. With a focus on fostering creativity, critical thinking, and technical skills, our programs empower students to become versatile designers capable of making an impact across various industries. Our dedicated faculty, comprised of industry experts, provides mentorship and guidance, encouraging students to push boundaries, experiment, and develop their unique design aesthetics. We emphasize hands-on projects that challenge creativity and problem-solving, ensuring graduates leave not only with technical prowess but also with a robust portfolio that showcases their ability to craft compelling visual narratives. Join us on a transformative journey where design transcends boundaries, sparks innovation, and communicates ideas that resonate with the world." ,
                    syllabusTitle: "",
                    syllabus: []
                }, {
                    id: "4",
                    title: "Video Editing ",
                    description: "Video editing is the art of storytelling through visual manipulation, weaving together moments, emotions, and narratives into a cohesive and impactful sequence. In our video editing courses, we delve deep into the tools and techniques that transform raw footage into compelling stories. From learning the intricacies of editing software like Adobe Premiere Pro and  Final Cut Pro to understanding the nuances of pacing, rhythm, and visual continuity, our curriculum caters to both beginners and advanced editors. Our experienced instructors, seasoned professionals in the industry, guide students through hands-on projects, imparting not just technical expertise but also the artistry of crafting engaging narratives. Whether it's mastering color grading, audio synchronization, special effects, or exploring various editing styles for different genres, our courses offer a comprehensive understanding of the video editing process. Join us and embark on a journey where your passion for storytelling merges seamlessly with the art and craft of video editing. Video editing is the alchemy that transforms raw footage into captivating stories, merging creativity with technical expertise to create seamless visual narratives. At our institute, our video editing courses are tailored to cater to the evolving demands of the industry, offering a comprehensive understanding of the editing process from inception to execution. Students delve into the realm of editing software like Adobe Premiere Pro, Avid Media Composer, and others, mastering the tools necessary to manipulate footage, refine pacing, perfect transitions, and enhance storytelling. Our seasoned instructors, with extensive industry experience, guide students through a curriculum that balances theory with hands-on practice, empowering them to explore their creative instincts while honing technical skills. From understanding the importance of visual rhythm and continuity to diving into advanced techniques like color grading, motion graphics, and sound design, our courses equip students with the versatility needed to excel in a dynamic and competitive field. Through practical projects that simulate real-world scenarios, students develop a robust portfolio that showcases their proficiency in crafting compelling visual narratives. Join us and unlock the power to craft stories that resonate, impact, and inspire through the artistry of video editing. ",
                    syllabusTitle: "",
                    syllabus: []
                }, {
                    id: "5",
                    title: "Digital Marketing",
                    description:  " Digital marketing is the dynamic ecosystem where innovation, strategy, and technology converge to shape the online presence and success of businesses. In our comprehensive digital marketing courses, we navigate the ever-evolving landscape of online strategies, equipping students with the tools and expertise needed to thrive in the digital realm. From understanding the fundamentals of SEO, SEM, and social media marketing to exploring content creation, email campaigns, and analytics, our curriculum covers the spectrum of digital marketing channels. Our experienced instructors, experts in the field, guide students through practical applications and real-world case studies, ensuring a deep understanding of how to leverage various platforms to drive engagement, conversions, and brand visibility. Whether it's mastering Google Analytics, creating compelling content, or understanding the intricacies of online advertising, our program aims to cultivate versatile digital marketers capable of navigating and thriving in today's competitive online landscape. Join us and embark on a transformative journey where you'll harness the power of digital tools to elevate brands and drive success in the digital sphere. Our digital marketing courses offer a comprehensive exploration of the multifaceted strategies and tools essential for success in this dynamic field. Students dive into the core pillars of digital marketing, from SEO and PPC advertising to social media management, content creation, email marketing, and beyond. Led by industry experts, our curriculum blends theory with hands-on experience, providing practical insights into analyzing data, understanding consumer behavior, and crafting targeted campaigns that resonate with specific audiences. Embracing the ever-evolving nature of the digital sphere, our courses also cover emerging trends like influencer marketing, chat bots, AI-driven marketing, and the optimization of mobile platforms. By instilling a deep understanding of analytics tools and emphasizing the importance of ROI-driven strategies, our goal is to empower students to navigate the digital landscape with confidence, adaptability, and a creative edge. Join us in mastering the art of digital marketing, where innovation and strategy converge to propel brands towards sustainable growth and meaningful connections in the digital age. ",
                    syllabusTitle: "",
                    syllabus: []
                }, {
                    id: "6",
                    title: "Accounts and Finance",
                    description: " Accounts and finance serve as the bedrock of every successful business, shaping crucial decisions and ensuring fiscal stability. Our comprehensive courses in accounts and finance offer a deep dive into the principles, methodologies, and practices that govern financial management. From understanding the fundamentals of accounting, financial analysis, and bookkeeping to exploring advanced topics such as corporate finance, investment management, and risk assessment, our curriculum caters to both beginners and professionals seeking to enhance their expertise. Led by industry practitioners and finance experts, our courses combine theoretical knowledge with practical applications, allowing students to grasp complex financial concepts and apply them in real-world scenarios. We emphasize the importance of financial reporting standards, budgeting, taxation, and strategic financial planning to equip students with the skills necessary for effective decision-making and sustainable growth. Whether it's learning about financial markets, mergers and acquisitions, or mastering financial software like Excel and accounting software, our goal is to empower individuals with the knowledge and acumen to navigate the intricate world of accounts and finance confidently. Join us on a transformative journey where you'll unlock the keys to fiscal prudence, strategic financial management, and unlocking opportunities in the global financial landscape. Our courses in accounts and finance are meticulously designed to provide a comprehensive understanding of financial principles and practices. Moving beyond the basics, our curriculum encompasses advanced topics such as managerial accounting, financial analysis, investment strategies, and risk management. Emphasizing the importance of compliance, ethical standards, and strategic financial planning, our goal is to equip individuals with the proficiency to navigate complex financial landscapes with confidence and expertise. Whether exploring financial markets, understanding tax implications, our program aims to empower students with the knowledge and skills essential for success in the dynamic and ever-evolving realms of accounts and finance. Join us in unlocking the realm of financial acumen, strategic thinking, and fiscal management expertise that fuels business success. ",
                    syllabusTitle: "",
                    syllabus: []
                }, {
                    id: "7",
                    ...
                    description: " Computer hardware and networking form the backbone of our digital infrastructure, enabling the seamless flow of information and connectivity across systems. Our courses in computer hardware and networking offer a comprehensive understanding of the components, architectures, and protocols that underpin modern computing systems. Students delve into the intricacies of computer hardware, learning about processors, memory, storage devices, and peripheral components. Beyond hardware, our curriculum explores networking essentials, including network topologies, protocols, routing, and security fundamentals. Led by industry experts and experienced professionals, our courses emphasize hands-on learning, providing practical experience in assembling computers, troubleshooting hardware issues, configuring networks, and implementing security measures. With a focus on industry-standard certifications like CompTIA A+, Network+, Cisco CCNA, and more, our program equips students with the skills and certifications necessary to excel in the field of computer hardware and networking. Whether it understands the latest advancements in hardware technology, setting up and managing networks, or troubleshooting complex network problems, our goal is to empower students with the expertise to thrive in a rapidly evolving technological landscape. Join us and embark on a transformative journey where you'll gain the knowledge and hands-on experience needed to become proficient in computer hardware and networking, paving the way for a successful career in IT infrastructure. Our courses in computer hardware and networking provide a comprehensive exploration of the intricate components that power computing devices and the intricate networks that interconnect them. Led by seasoned instructors and industry professionals, our program emphasizes practical learning through simulations, labs, and real-world scenarios, preparing students for the complexities of IT infrastructure management. Whether it's building, maintaining, or troubleshooting hardware systems, designing and securing networks, or optimizing network performance, our courses empower students to become adept problem solvers and IT professionals capable of navigating the dynamic world of computer hardware and networking. Join us on an enriching journey where you'll gain the technical expertise and hands-on skills needed to excel in the ever-evolving landscape of technology and IT infrastructure. " ,
                    syllabusTitle: "",
                    syllabus: []
                }, {
                    id: "8",
                    title: "Web Development",
                    description: " Web development is the art and science of crafting immersive, functional, and user-centric digital experiences that breathe life into the online world. Our courses in web development offer a comprehensive journey into the realm of coding languages, frameworks, and design principles that shape the internet. Students delve into HTML, CSS, and JavaScript—the foundational languages of the web—learning how to structure content, style layouts, and add interactivity to web pages. Beyond the basics, our curriculum explores front-end and back-end development, introducing frameworks like React, Angular, Vue.js for front-end, and Node.js, Django, or Ruby on Rails for back-end development. Led by experienced developers and industry experts, our program emphasizes hands-on projects, guiding students in building responsive, dynamic websites and web applications. From understanding database management systems to mastering version control and deployment techniques, our courses provide a holistic understanding of the web development process. We focus on responsive design, user experience optimization, and industry best practices, ensuring that graduates are well-equipped to create engaging, functional, and scalable web solutions. Join us and embark on an exhilarating journey where you'll transform your passion for coding into a rewarding career, shaping the digital landscape with your innovative web creations. Web development is a dynamic field where creativity meets technology, shaping the digital world we interact with daily. Our courses in web development offer a comprehensive exploration of the tools, languages, and methodologies essential for crafting immersive online experiences. Students dive into the core languages and technologies like HTML, CSS, and JavaScript, learning how to structure content, design layouts, and add interactive elements to websites. Guided by industry professionals, our program emphasizes project-based learning, enabling students to apply their skills in real-world scenarios, whether it's creating e-commerce platforms, social networks, or interactive web apps. We also focus on best practices in web security, performance optimization, and version control systems, ensuring graduates are well-equipped to create secure, user-friendly, and high-performing web solutions. Join us on an exciting journey where you'll hone your coding skills, embrace innovation, and become proficient in crafting impactful web experiences that shape the digital landscape. ",
                    syllabusTitle: "",
                    syllabus: []
                  }
                  , {
                    id: "9",
                    title: "Soft Skills",
                    description:  " Soft skills are the invaluable attributes that complement technical expertise, shaping individuals into well-rounded professionals capable of thriving in diverse work environments. Our courses in soft skills focus on developing essential traits that encompass communication, interpersonal skills, adaptability, problem-solving, leadership, and emotional intelligence. Through interactive workshops, role-playing exercises, and personalized coaching, our program hones communication skills, teaching effective verbal and non-verbal communication techniques crucial for collaboration and relationship-building in professional settings. We emphasize adaptability and resilience, equipping students with the tools to navigate change and uncertainty. Moreover, our curriculum fosters critical thinking and problem-solving abilities, empowering individuals to tackle complex challenges creatively. Leadership development is also a key focus, nurturing qualities that inspire and motivate teams towards collective success. Additionally, our courses delve into emotional intelligence, cultivating self-awareness, empathy, and social skills essential for fostering healthy workplace relationships and managing conflicts adeptly. By integrating these soft skills into our program, we aim to produce well-rounded individuals capable of not only excelling in their technical domains but also thriving as effective communicators, team players, and leaders in today's professional landscape. Join us and enhance your professional toolkit with the soft skills necessary for personal growth, career advancement, and success in a rapidly evolving work environment. Communication skills take center stage, encompassing verbal, non-verbal, and written communication, empowering students to convey ideas effectively, actively listen, and engage with diverse audiences. Adaptability and resilience training equip individuals to navigate change and challenges with grace, fostering a growth mindset crucial for personal and professional development. Moreover, our courses emphasize critical thinking, problem-solving, and decision-making skills, enabling students to analyze situations, strategize solutions, and make informed choices. Leadership development is integrated, nurturing qualities like mentorship, motivation, and empowerment to inspire and guide teams effectively.  By intertwining these soft skills into our curriculum, we aim to produce graduates who are not only proficient in their technical fields but also possess the interpersonal finesse and adaptability to excel in any professional setting. Join us and refine your soft skills toolkit, unlocking your potential for personal growth and career success in today's dynamic workplace. " ,
                    syllabusTitle: "",
                    syllabus: []
                }],
